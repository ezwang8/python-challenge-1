        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"How many of {item_name} would you like to buy? ")
                    ...
                    print("The selected item is not on the menu. Please choose a valid item.")
...
for item in order:
    ...
    quantity_spaces = quantity_width - len(str(quantity))
    
    # 9. Create space strings
    item_space_str = " " * item_spaces
    price_space_str = " " * price_spaces
    quantity_space_str = " " * quantity_spaces


    # 10. Print the item name, price, and quantity
    print(f"{item_name}{item_space_str} | {price_space_str}${price:.2f} | {quantity_space_str}{quantity}")
